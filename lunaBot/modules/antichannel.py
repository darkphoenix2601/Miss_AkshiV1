...
from lunaBot.modules.helper_funcs.decorators import LUNACMD, LUNAMSG
from lunaBot.modules.helper_funcs.channel_mode import user_admin, AdminPerms
from lunaBot.modules.sql.antichannel_sql import antichannel_status, disable_antichannel, enable_antichannel

@LUNACMD(command="antichannelmode", group=100)
...
@LUNAMSG(Filters.chat_type.groups, group=110)
